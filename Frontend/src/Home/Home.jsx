        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div 
                key={index} 
                className="bg-white/10 backdrop-blur-md rounded-xl p-6 text-center hover:bg-white/20 transition-all duration-300 animate-fadeIn"
      ...
      <div className="py-24 bg-black relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 animate-fadeIn">Ready to Transform Your Learning Journey?</h2>
            <p className="text-xl text-gray-300 mb-10 animate-fadeIn">Join thousands of students who have already taken their education to the next level.</p>
            <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded-full text-lg flex items-center mx-auto transition-all duration-300 hover:shadow-lg hover:scale-105">
              Get Started Today
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="mt-2 flex">
                <input type="email" placeholder="Enter your email" className="bg-gray-800 text-white px-4 py-2 rounded-l focus:outline-none focus:ring-2 focus:ring-blue-500 w-full" />
